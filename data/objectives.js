// NIST 800-171A / CMMC Level 2 Assessment Objectives
// Based on NIST SP 800-171A Rev 2
        ...
        controls: [
            {
                ...
                objectives: [
                    ...
                    { id: "3.1.1[c]", text: "Devices authorized to connect to the system are identified." },
                    ...
                    { id: "3.1.1[f]", text: "System access is limited to authorized devices." }
                ]
            },
            {
                id: "3.1.2",
                name: "Transaction & Function Access Control",
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.1.3[c]", text: "Designated sources and destinations for CUI are identified." },
            ...
            {
                id: "3.1.7",
                name: "Privileged Function Control",
            ...
            },
            {
                ...
                objectives: [
                    { id: "3.1.9[a]", text: "Privacy and security notices required by CUI-specified rules are identified." },
            ...
            {
                id: "3.1.19",
                name: "Mobile Device CUI Encryption",
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.1.20[c]", text: "Connections to external systems are verified and controlled/limited." },
                    { id: "3.1.20[d]", text: "Use of external systems is verified and controlled/limited." }
                ]
            },
            {
                id: "3.1.21",
                ...
                objectives: [
                    { id: "3.1.21[a]", text: "The use of portable storage devices containing CUI on external systems is identified." },
                    { id: "3.1.21[b]", text: "Limits on the use of portable storage devices containing CUI on external systems are defined and enforced." }
                ]
            },
            {
                id: "3.1.22",
                name: "Publicly Accessible Content Control",
        ...
        controls: [
            {
                ...
                objectives: [
                    ...
                    { id: "3.2.1[c]", text: "Managers, systems administrators, and users are made aware of the security risks associated with their activities." },
                    { id: "3.2.1[d]", text: "Managers, systems administrators, and users are made aware of the applicable policies, standards, and procedures." }
                ]
            },
            {
                id: "3.2.2",
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.2.3[b]", text: "Security awareness training on recognizing and reporting potential indicators of insider threat is provided." }
                ]
            }
        ]
    },
        ...
        controls: [
            {
                ...
                objectives: [
                    { id: "3.3.1[a]", text: "Audit logs needed to enable monitoring, analysis, investigation, and reporting are specified." },
                    { id: "3.3.1[b]", text: "The content of audit records needed to support monitoring, analysis, investigation, and reporting is defined." },
                    { id: "3.3.1[c]", text: "Audit records are created (generated)." },
                    { id: "3.3.1[d]", text: "Audit records contain the defined content." },
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.3.2[b]", text: "Audit records contain the defined content." }
                ]
            },
            {
                id: "3.3.3",
                ...
                objectives: [
                    { id: "3.3.3[a]", text: "A process for reviewing and updating logged events is defined." },
                    { id: "3.3.3[b]", text: "Logged events are reviewed and updated in accordance with the defined process." }
                ]
            },
            {
                id: "3.3.4",
            ...
            },
            {
                ...
                objectives: [
                    { id: "3.3.5[a]", text: "Audit record review, analysis, and reporting processes are defined." },
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.3.7[c]", text: "Internal system clocks are compared to and synchronized with the specified authoritative time source." }
                ]
            },
            {
                id: "3.3.8",
                name: "Audit Information Protection",
                description: "Protect audit information and audit logging tools from unauthorized access, modification, and deletion.",
                objectives: [
                    { id: "3.3.8[a]", text: "Audit information is protected from unauthorized access, modification, and deletion." },
                    { id: "3.3.8[b]", text: "Audit logging tools are protected from unauthorized access, modification, and deletion." }
                ]
            },
            {
                id: "3.3.9",
                name: "Audit Management Limitation",
        ...
        controls: [
            {
                ...
                objectives: [
                    ...
                    { id: "3.4.1[c]", text: "The baseline configuration is maintained throughout the system development life cycle." },
                    { id: "3.4.1[d]", text: "A system inventory is established and maintained." }
                ]
            },
            {
                id: "3.4.2",
                ...
                objectives: [
                    { id: "3.4.2[a]", text: "Security configuration settings for IT products are established and included in the baseline configuration." },
                    { id: "3.4.2[b]", text: "Security configuration settings for IT products are enforced." }
                ]
            },
            {
                id: "3.4.3",
            ...
            },
            {
                ...
                objectives: [
                    { id: "3.4.5[a]", text: "Physical access restrictions associated with changes to the system are defined, documented, approved, and enforced." },
                    { id: "3.4.5[b]", text: "Logical access restrictions associated with changes to the system are defined, documented, approved, and enforced." }
                ]
            },
            {
                id: "3.4.6",
            ...
            },
            {
                ...
                objectives: [
                    { id: "3.4.7[a]", text: "Essential programs, functions, ports, protocols, and services are defined." },
                    { id: "3.4.7[b]", text: "The use of nonessential programs, functions, ports, protocols, and services is restricted, disabled, or prevented." }
                ]
            },
            {
                id: "3.4.8",
                name: "Application Execution Policy",
                description: "Apply deny-by-exception (blacklisting) or deny-all, permit-by-exception (whitelisting) policy.",
                objectives: [
                    { id: "3.4.8[a]", text: "A policy specifying whether whitelisting or blacklisting is to be implemented is specified." },
                    { id: "3.4.8[b]", text: "The software allowed or denied is specified." },
                    { id: "3.4.8[c]", text: "Whitelisting or blacklisting is implemented as specified." }
                ]
            },
            {
                id: "3.4.9",
        ...
        controls: [
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.5.2[b]", text: "The identity of each process acting on behalf of a user is authenticated or verified." },
                    { id: "3.5.2[c]", text: "The identity of each device is authenticated or verified as a prerequisite to system access." }
                ]
            },
            {
                id: "3.5.3",
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.5.7[c]", text: "Minimum password complexity requirements are enforced when new passwords are created." },
                    { id: "3.5.7[d]", text: "Minimum password change of character requirements are enforced when new passwords are created." }
                ]
            },
            {
                id: "3.5.8",
            ...
            },
            {
                ...
                objectives: [
                    ...
                    { id: "3.5.9[b]", text: "An immediate change to a permanent password is required when a temporary password is used." }
                ]
            },
            {
                id: "3.5.10",
