// MSSP Playbook Data - Technical/Tactical Guidance for MSSPs
...
const MSSP_PLAYBOOK_DATA = {
  ...
  "scopingDecisionMatrix": {
    ...
    "categories": [
      {
        ...
        "examples": [
          "File servers with CUI",
          "Email systems handling CUI",
          "ERP with contract data",
          "CAD workstations",
          "CUI databases"
        ],
        "requirements": [
          "Must use FedRAMP Mod/High authorized tools",
          "Full CMMC control set applies",
          "Must be in assessment scope",
          "Requires FIPS 140-2/3 validated encryption"
        ],
        "color": "#f87171"
      },
      {
        ...
        "examples": [
          ...
          "MFA providers",
          "DLP tools",
          "Backup systems (if not storing CUI)"
        ],
        "requirements": [
          "FedRAMP recommended but NOT required",
          "Security controls apply to protect integrity",
          "Must be documented in SSP",
          "Commercial tools acceptable with risk acceptance"
        ],
        "color": "#a78bfa"
      },
      {
        ...
        "examples": [
          "Corporate laptops not handling CUI",
          "General office network",
          "HR systems",
          "Accounting software"
        ],
        "requirements": [
          "Contractor determines controls",
          "Must not introduce unacceptable risk",
          "Document risk acceptance",
          "Network segmentation from CUI recommended"
        ],
        "color": "#94a3b8"
      },
      {
        ...
        "examples": [
          "Guest WiFi (isolated)",
          "Personal devices (no CUI access)",
          "Marketing systems",
          "Public website"
        ],
        "requirements": [
          "No CMMC controls required",
          "Must be physically/logically separated",
          "Document separation in SSP"
        ],
        "color": "#6b7280"
      }
    ],
    "decisionTree": [
      {
        "question": "Does this asset process, store, or transmit CUI?",
        "yes": "CUI Asset",
        "no": "next"
      },
      {
        "question": "Does this asset provide security protection to CUI assets?",
        "yes": "Security Protection Asset (SPA)",
        "no": "next"
      },
      {
        "question": "Can this asset access or connect to CUI assets?",
        "yes": "Contractor Risk Managed Asset (CRMA)",
        "no": "Out of Scope"
      }
    ]
  },
        ...
        "tools": [
          {
            "name": "Okta",
            "fedramp": "High",
            "bestFor": "Cloud-first orgs, SSO/MFA",
            "msspFit": "Excellent",
            "cost": "$6-15/user/mo",
            "notes": "Best IdP for multi-tenant MSSP. Lifecycle automation via Workflows."
          },
          {
            "name": "CyberArk",
            "fedramp": "High",
            "bestFor": "PAM, privileged accounts",
            "msspFit": "Excellent",
            "cost": "$50-100/priv user/mo",
            "notes": "Gold standard for PAM. Session recording, JIT access."
          },
          {
            "name": "JumpCloud",
            "fedramp": "Moderate",
            "bestFor": "SMB cloud directory",
            "msspFit": "Good",
            "cost": "$7-15/user/mo",
            "notes": "Good for smaller clients. Cross-platform directory."
          },
          {
            "name": "Cisco Duo",
            "fedramp": "High",
            ...
            "msspFit": "Excellent",
            "cost": "$3-9/user/mo",
            "notes": "Easy MFA overlay. Trust Monitor for anomaly detection."
          },
          {
            "name": "Keeper Security",
            "fedramp": "Moderate",
            "bestFor": "Password management",
            "msspFit": "Good",
            "cost": "$4-8/user/mo",
            "notes": "BreachWatch, Secrets Manager. Good for SMB."
          },
          {
            "name": "BeyondTrust",
            "fedramp": "Moderate",
            "bestFor": "Endpoint privilege mgmt",
            "msspFit": "Good",
            "cost": "$30-60/user/mo",
            "notes": "EPM + Password Safe. Good for hybrid environments."
          },
          {
            "name": "Delinea",
            "fedramp": "High",
            "bestFor": "Secret Server, PAM",
            "msspFit": "Good",
            "cost": "$30-70/user/mo",
            "notes": "Strong PAM with JIT. Good for on-prem heavy."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            "name": "Splunk Cloud",
            "fedramp": "High",
            "bestFor": "Advanced analytics, on-prem heavy",
            "msspFit": "Excellent",
            "cost": "$15-50/GB/day",
            "notes": "Most powerful SIEM. ES + SOAR. High cost but unmatched flexibility."
          },
          {
            "name": "Microsoft Sentinel",
            "fedramp": "High",
            "bestFor": "M365/Azure environments",
            "msspFit": "Excellent",
            "cost": "$2.46/GB ingested",
            "notes": "Native M365 integration. Lighthouse for multi-tenant. KQL."
          },
          {
            "name": "Sumo Logic",
            "fedramp": "Moderate",
            "bestFor": "Cloud-native SIEM",
            "msspFit": "Good",
            "cost": "$3-10/GB/day",
            "notes": "Cloud SIEM with built-in compliance dashboards."
          },
          {
            "name": "Blumira",
            "fedramp": "N/A",
            ...
            "msspFit": "Good",
            "cost": "$3-7/user/mo",
            "notes": "Pre-built detections. Low effort to deploy. Great for SMB clients."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            "name": "Cortex XSOAR",
            "fedramp": "Moderate",
            "bestFor": "Enterprise SOAR",
            "msspFit": "Excellent",
            "cost": "$40-100K/year",
            "notes": "Most mature SOAR. 800+ integrations. War rooms."
          },
          {
            "name": "Splunk SOAR",
            "fedramp": "High",
            "bestFor": "Splunk-centric SOCs",
            "msspFit": "Excellent",
            "cost": "Included w/ ES Premium",
            "notes": "Tight Splunk integration. Visual playbook editor."
          },
          {
            "name": "Tines",
            "fedramp": "N/A",
            ...
            "msspFit": "Good",
            "cost": "Free community/$50K+",
            "notes": "Stories-based automation. Free tier available."
          },
          {
            "name": "Swimlane",
            "fedramp": "N/A",
            "bestFor": "Low-code SOAR",
            "msspFit": "Good",
            "cost": "$30-80K/year",
            "notes": "Turbine platform. Good for custom workflows."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            ...
            "fedramp": "High",
            "bestFor": "Enterprise EDR/XDR",
            "msspFit": "Excellent",
            "cost": "$15-25/endpoint/mo",
            "notes": "Best-in-class EDR. ITDR, Device Control, OverWatch MDR."
          },
          {
            "name": "SentinelOne",
            "fedramp": "Moderate",
            "bestFor": "Autonomous EDR",
            "msspFit": "Excellent",
            "cost": "$6-12/endpoint/mo",
            "notes": "AI-driven. Good multi-tenant. Ranger for network discovery."
          },
          {
            "name": "Huntress",
            "fedramp": "N/A",
            "bestFor": "MSP-focused MDR",
            "msspFit": "Excellent",
            "cost": "$3-5/endpoint/mo",
            "notes": "Built for MSPs. 24/7 SOC included. Identity threat detection."
          },
          {
            "name": "Sophos",
            "fedramp": "N/A",
            "bestFor": "SMB endpoint protection",
            "msspFit": "Good",
            "cost": "$3-8/endpoint/mo",
            "notes": "Intercept X + MDR. Good for budget-conscious clients."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            "name": "Proofpoint",
            "fedramp": "High",
            "bestFor": "Enterprise email security",
            "msspFit": "Excellent",
            "cost": "$3-8/user/mo",
            "notes": "TAP for advanced threats. URL defense. Best for large orgs."
          },
          {
            "name": "Mimecast",
            "fedramp": "Moderate",
            "bestFor": "Email gateway + archive",
            "msspFit": "Good",
            "cost": "$3-7/user/mo",
            "notes": "TTP for URL/attachment. Good archiving. DMARC management."
          },
          {
            "name": "Abnormal Security",
            "fedramp": "N/A",
            "bestFor": "AI email defense",
            "msspFit": "Good",
            "cost": "$4-10/user/mo",
            "notes": "Behavioral AI for BEC. Account takeover protection."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            ...
            "bestFor": "M365 DLP",
            "msspFit": "Excellent",
            "cost": "Included w/ E5/G5",
            "notes": "Best for M365 shops. Sensitivity labels, endpoint DLP."
          },
          {
            "name": "Netskope",
            "fedramp": "Moderate",
            "bestFor": "CASB + cloud DLP",
            "msspFit": "Good",
            "cost": "$10-25/user/mo",
            "notes": "CASB, DLP, Private Access. Good for multi-cloud."
          },
          {
            "name": "Code42 Incydr",
            "fedramp": "N/A",
            "bestFor": "Insider risk",
            "msspFit": "Good",
            "cost": "$8-15/user/mo",
            "notes": "File exposure detection. Insider risk indicators."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            "name": "Tenable.io",
            "fedramp": "High",
            "bestFor": "Enterprise vuln mgmt",
            "msspFit": "Excellent",
            "cost": "$30-65/asset/year",
            "notes": "VMDR, compliance scanning, VPR scoring."
          },
          {
            "name": "Qualys VMDR",
            "fedramp": "High",
            "bestFor": "Cloud-native vuln mgmt",
            "msspFit": "Excellent",
            "cost": "$25-60/asset/year",
            "notes": "Cloud agents, policy compliance, TotalCloud."
          },
          {
            "name": "Rapid7 InsightVM",
            "fedramp": "Moderate",
            "bestFor": "Risk-based vuln mgmt",
            "msspFit": "Good",
            "cost": "$20-50/asset/year",
            "notes": "Real Risk Score, InsightConnect integration."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            "name": "Darktrace",
            "fedramp": "N/A",
            "bestFor": "AI network detection",
            "msspFit": "Good",
            "cost": "$20-100K/year",
            "notes": "Enterprise Immune System. RESPOND autonomous actions."
          },
          {
            "name": "Vectra AI",
            "fedramp": "N/A",
            "bestFor": "Network + identity detection",
            "msspFit": "Good",
            "cost": "$15-80K/year",
            "notes": "Host and account scoring. Good for lateral movement detection."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            "name": "Vanta",
            "fedramp": "N/A",
            "bestFor": "Continuous compliance",
            "msspFit": "Excellent",
            "cost": "$5-15K/year",
            "notes": "Auto evidence collection. Access reviews. Multi-framework."
          },
          {
            "name": "Drata",
            "fedramp": "N/A",
            "bestFor": "Compliance automation",
            "msspFit": "Excellent",
            "cost": "$5-20K/year",
            "notes": "Monitoring + evidence. Good UI. Multi-framework."
          },
          {
            "name": "Secureframe",
            "fedramp": "N/A",
            "bestFor": "SMB compliance",
            "msspFit": "Good",
            "cost": "$5-15K/year",
            "notes": "Easy setup. Good for smaller clients."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            "name": "Veeam",
            "fedramp": "Moderate",
            "bestFor": "Enterprise backup",
            "msspFit": "Excellent",
            "cost": "$5-15/workload/mo",
            "notes": "Immutable backups, encryption. Veeam ONE monitoring."
          },
          {
            "name": "Druva",
            "fedramp": "Moderate",
            "bestFor": "Cloud backup",
            "msspFit": "Good",
            "cost": "$3-8/user/mo",
            "notes": "SaaS backup. Air-gapped. Ransomware protection."
          },
          {
            "name": "Acronis",
            "fedramp": "N/A",
            "bestFor": "MSP backup",
            "msspFit": "Good",
            "cost": "$3-10/workload/mo",
            "notes": "Cyber Protect Cloud. Built for MSPs."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            ...
            "fedramp": "High",
            "bestFor": "Windows/cross-platform",
            "msspFit": "Excellent",
            "cost": "Included w/ E3/E5",
            "notes": "Security baselines, compliance policies, Conditional Access."
          },
          {
            "name": "Jamf Pro",
            "fedramp": "Moderate",
            "bestFor": "Apple devices",
            "msspFit": "Good",
            "cost": "$4-8/device/mo",
            "notes": "Best for Apple-heavy environments. Jamf Protect."
          },
          {
            "name": "Kandji",
            "fedramp": "N/A",
            ...
            "msspFit": "Good",
            "cost": "$5-9/device/mo",
            "notes": "Auto-remediation. Compliance library."
          },
          {
            "name": "Workspace ONE",
            "fedramp": "Moderate",
            "bestFor": "Enterprise UEM",
            "msspFit": "Good",
            "cost": "$5-12/device/mo",
            "notes": "Cross-platform. Access + Intelligence."
          }
        ]
      },
      {
        ...
        "tools": [
          {
            ...
            "msspFit": "Excellent",
            "cost": "$3-6/device/mo",
            "notes": "Patch management, scripting, monitoring. MSP-native."
          },
          {
            "name": "Datto RMM",
            "fedramp": "N/A",
            ...
            "msspFit": "Excellent",
            "cost": "$3-5/device/mo",
            "notes": "ComStore, monitoring. Good PSA integration."
          },
          {
            "name": "ConnectWise Automate",
            "fedramp": "Moderate",
            "bestFor": "MSP automation",
            "msspFit": "Excellent",
            "cost": "$3-6/device/mo",
            "notes": "Deep scripting. Patch management. PSA integration."
          }
        ]
      }
    ]
  ...
  "socPlaybooks": [
    {
      ...
      "automationOpportunities": [
        "Auto-disable account if no matching ticket",
        "Auto-enrich with HR system data",
    ...
    },
    {
      ...
      "automationOpportunities": [
        ...
        "Auto-lock targeted accounts",
        "Auto-enrich IP with threat intel",
        "Auto-force MFA challenge"
      ],
    ...
    },
    {
      ...
      "automationOpportunities": [
        "Auto-block large transfers to uncategorized destinations",
        "Auto-isolate endpoint on DLP critical match",
        "Auto-capture network forensics"
      ],
    ...
    },
    {
      ...
      "automationOpportunities": [
        "Auto-terminate session if no PAM checkout",
        "Auto-rotate credentials",
        "Auto-enrich with PAM checkout data"
      ],
    ...
    },
    {
      ...
      "automationOpportunities": [
        "Auto-isolate endpoint on critical EDR alert",
        "Auto-scan environment for IOCs",
        "Auto-block hashes at EDR policy level",
        "Auto-create forensic snapshot"
      ],
    ...
    },
    {
      ...
      "automationOpportunities": [
        ...
        "Auto-reset passwords for clickers",
        "Auto-block sender domain",
        "Auto-check for forwarding rules"
      ],
    ...
    },
    {
      ...
      "automationOpportunities": [
        "Auto-alert on log source silence",
        "Auto-restart agents",
        "Auto-create ticket for logging gaps"
      ],
    ...
    },
    {
      ...
      "automationOpportunities": [
        "Auto-remediate common drift (GPO reapply, Intune sync)",
        "Auto-create change ticket",
        "Auto-rescan after remediation"
      ],
    ...
    "phases": [
      {
        ...
        "tasks": [
          {
            "task": "Conduct CUI data flow analysis",
            "critical": true,
            "tools": [
              "Interviews",
              "Network diagrams",
          ...
          {
            "task": "Identify all CUI assets, SPAs, and CRMAs",
            "critical": true,
            "tools": [
              "Asset inventory",
              "Network scanning",
          ...
          {
            "task": "Document current security posture (gap assessment)",
            "critical": true,
            "tools": [
          ...
          {
            "task": "Calculate initial SPRS score",
            "critical": true,
            "tools": [
              "NIST Assessment Tool SPRS Calculator"
            ]
          },
          {
            "task": "Define CUI boundary and network segmentation plan",
            "critical": true,
            "tools": [
              "Network diagrams",
          ...
          {
            "task": "Identify FedRAMP requirements for CUI assets",
            "critical": false,
            "tools": [
              "FedRAMP Marketplace",
      ...
      },
      {
        ...
        "tasks": [
          {
            "task": "Deploy EDR/XDR on all CUI endpoints",
            "critical": true,
            "tools": [
              "CrowdStrike",
              "SentinelOne",
          ...
          {
            "task": "Configure SIEM with all required log sources",
            "critical": true,
            "tools": [
              "Splunk",
              "Sentinel",
          ...
          {
            "task": "Deploy MFA on all CUI access points",
            "critical": true,
            "tools": [
              "Okta",
              "Duo",
          ...
          {
            "task": "Configure DLP for CUI data protection",
            "critical": true,
            "tools": [
              "Purview",
              "Netskope"
          ...
          {
            "task": "Deploy MDM/UEM for endpoint management",
            "critical": false,
            "tools": [
              "Intune",
              "Jamf",
          ...
          {
            "task": "Configure backup with encryption and immutability",
            "critical": false,
            "tools": [
              "Veeam",
              "Druva",
          ...
          {
            "task": "Deploy email security gateway",
            "critical": false,
            "tools": [
              "Proofpoint",
              "Mimecast"
      ...
      },
      {
        ...
        "tasks": [
          {
            "task": "Configure security baselines on all CUI systems",
            "critical": true,
            "tools": [
              "Intune",
              "GPO",
          ...
          {
            "task": "Set up SIEM correlation rules and alerts",
            "critical": true,
            "tools": [
              "SIEM platform"
            ]
          ...
          {
            "task": "Configure PAM for all privileged accounts",
            "critical": true,
            "tools": [
              "CyberArk",
              "Delinea",
          ...
          {
            "task": "Implement network segmentation for CUI",
            "critical": true,
            "tools": [
              "Firewall",
              "Zscaler",
          ...
          {
            "task": "Deploy security awareness training",
            "critical": false,
            "tools": [
              "KnowBe4",
              "Ninjio"
          ...
          {
            "task": "Configure GRC platform for continuous monitoring",
            "critical": false,
            "tools": [
              "Vanta",
              "Drata"
      ...
      },
      {
        ...
        "tasks": [
          {
            "task": "Run full vulnerability scan and remediate critical findings",
            "critical": true,
            "tools": [
              "Vuln scanner"
            ]
          ...
          {
            "task": "Validate all SIEM log sources are reporting",
            "critical": true,
            "tools": [
          ...
          {
            "task": "Test incident response playbooks",
            "critical": true,
            "tools": [
              "Tabletop exercise"
            ]
          ...
          {
            "task": "Complete System Security Plan (SSP)",
            "critical": true,
            "tools": [
              "SSP template"
            ]
          ...
          {
            "task": "Calculate final SPRS score",
            "critical": true,
            "tools": [
              "NIST Assessment Tool"
            ]
          ...
          {
            "task": "Create POA&M for any remaining gaps",
            "critical": true,
            "tools": [
              "POA&M template"
            ]
  ...
  "incidentReporting": {
    ...
    "timeline": [
      {
        "time": "0-1 hours",
        "action": "Detect and contain",
        "details": "Isolate affected systems, preserve evidence, activate IR team"
      },
      {
        "time": "1-4 hours",
        "action": "Initial assessment",
        "details": "Determine scope, identify CUI impact, classify severity"
      },
      {
        "time": "4-24 hours",
        "action": "Detailed investigation",
        "details": "Forensic analysis, IOC identification, impact assessment"
      },
      {
        "time": "24-48 hours",
        "action": "Prepare report",
        "details": "Complete DIBNet incident report form, gather required data"
      },
      {
        "time": "Within 72 hours",
        "action": "Report to DoD",
        "details": "Submit via DIBNet (https://dibnet.dod.mil). Include: company info, incident description, CUI affected, compromised systems, actions taken"
      },
      {
        "time": "72+ hours",
        "action": "Ongoing cooperation",
        "details": "Preserve images for 90 days, cooperate with DoD investigation, provide additional data as requested"
      }
    ],
    "requiredData": [
