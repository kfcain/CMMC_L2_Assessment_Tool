        ...
        if (!overlay) {
            ...
            overlay.innerHTML = `
                <div class="login-card">
                    ...
                    <button class="btn-google-signin-large" onclick="evidenceUI.signInWithGoogle()">
        ...
        container.innerHTML = `
            <div class="selector-section">
                ...
                <div class="selector-row">
                    ...
                    <button class="btn-icon-small" onclick="evidenceUI.showCreateOrgModal()" title="Create Organization">
            ...
            ${currentOrg ? `
                <div class="selector-section">
                    ...
                    <div class="selector-row">
                        ...
                        <button class="btn-icon-small" onclick="evidenceUI.showCreateAssessmentModal()" title="Create Assessment">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                        </button>
                    </div>
                </div>
        ...
        if (supabaseClient.isAuthenticated()) {
            ...
            container.innerHTML = `
                <div class="auth-user">
                    ...
                    <button class="btn-icon" onclick="evidenceUI.showProfileModal()" title="Profile">
        ...
        modal.innerHTML = `
            <div class="modal-content profile-modal-content">
                <div class="modal-header">
                    ...
                    <button class="modal-close" onclick="evidenceUI.closeProfileModal()">
                ...
                <div class="modal-body">
                    ...
                    <form id="profile-form" onsubmit="evidenceUI.saveProfile(event)">
                        ...
                        <div class="form-actions">
                            <button type="button" class="btn-cancel" onclick="evidenceUI.closeProfileModal()">Cancel</button>
